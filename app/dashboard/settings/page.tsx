...
const categories = [
  ...
  { key: "api", label: "API Configuration", icon: Code2, pill: "Connected" },
  { key: "team", label: "Team Members", icon: Users, badge: "4" },
...
export default function SettingsPage() {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
      <Card className="h-[calc(100vh-7rem)] rounded-xl border-slate-200 bg-white">
        <CardContent className="flex h-full flex-col p-3">
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center justify-between rounded-lg border-l-4 px-3 py-2 text-sm ${isActive ? "border-l-slate-900 bg-blue-50 text-slate-900" : "border-l-transparent text-slate-600 hover:bg-slate-100"}`}
                >
                  ...
                  <span className="flex items-center gap-1">
                    {category.badge && <span className="rounded-full bg-slate-200 px-2 py-0.5 text-xs">{category.badge}</span>}
                    {category.pill && <span className="rounded-full bg-emerald-100 px-2 py-0.5 text-xs text-emerald-700">{category.pill}</span>}
          ...
          <div className="mt-auto rounded-xl bg-blue-50 p-3 text-sm">
            <p className="font-medium text-slate-900">Need Help?</p>
            <div className="mt-1 flex gap-3 text-blue-700">
              <a href="#">View Docs</a>
